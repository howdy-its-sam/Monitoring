# Gemini Thinking Process Analysis Template

Use this template to capture and analyze Gemini's reasoning during the analysis pipeline.
...
```
[Copy/paste relevant excerpts from Gemini's thinking here]
```
...
### Quality Differences
- **Better at:** [What did Gemini do better?]
- **Worse at:** [What did ChatGPT do better?]
